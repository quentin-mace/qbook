<section class="d-flex align-items-center justify-content-center vh-100 flex-column">
    ...
    <form class="my-1 d-flex flex-column align-items-center justify-content-center w-100" action="index.php?action=updateAccountInfo" method="post">
        <div class="my-3 w-50">
            ...
            <input type="text" class="form-control" id="name" placeholder="Nom" name="name" value="<?= $user->getName(); ?>" required>
        </div>
        <div class="my-3 w-50">
            <label for="email" hidden="hidden">E-mail</label>
            <input type="email" class="form-control" id="email" placeholder="Adresse email" name="email" value="<?= $user->getEmail(); ?>" required>
        </div>
    ...
    <form class="my-1 d-flex flex-column align-items-center justify-content-center w-100" action="index.php?action=updatePassword" method="post">
        <div class="my-3 w-50">
            ...
            <input type="password" class="form-control" id="oldPassword" placeholder="Ancien mot de passe" name="oldPassword" required>
        </div>
        <div class="my-3 w-50">
            <label for="newPassword" hidden="hidden">New Password</label>
            <input type="password" class="form-control" id="newPassword" placeholder="Nouveau mot de passe" name="newPassword" required>
        </div>
        <div class="my-3 w-50">
            <label for="confirmPassword" hidden="hidden">Confirm New Password</label>
            <input type="password" class="form-control" id="confirmPassword" placeholder="Confirmer nouveau mot de passe" name="confirmPassword" required>
        </div>
