...
foreach ($rooms as $room): ?>
    <div class="modal fade" id="showModal<?= $room->getId(); ?>" tabindex="-1" aria-labelledby="showModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a type="submit" href="index.php?action=deleteRoom&id=<?= $room->getId(); ?>" class="btn btn-danger" <?= Utils::askConfirmation("Êtes vous sûr de vouloir supprimer cette salle ?"); ?>>Supprimer</a>
                </div>
            </div>
        </div>
    </div>
